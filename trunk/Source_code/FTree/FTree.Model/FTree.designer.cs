...
namespace FTree.Model
{
    ...
    partial void OnNameChanged();
		...
		[Association(Name="BURYPLACE_DEATH_INFO", Storage="_DEATH_INFOs", ThisKey="IDBuryPlace", OtherKey="IDBuryPlace")]
    ...
    partial void OnNameChanged();
		...
		[Association(Name="BURYREASON_DEATH_INFO", Storage="_DEATH_INFOs", ThisKey="IDBuryReason", OtherKey="IDBuryReason")]
		public EntitySet<DEATH_INFO> DEATH_INFOs
		{
			get
			{
    ...
    partial void OnBuryDayChanged();
		...
		[Association(Name="BURYPLACE_DEATH_INFO", Storage="_BURYPLACE", ThisKey="IDBuryPlace", OtherKey="IDBuryPlace", IsForeignKey=true)]
		...
		[Association(Name="BURYREASON_DEATH_INFO", Storage="_BURYREASON", ThisKey="IDBuryReason", OtherKey="IDBuryReason", IsForeignKey=true)]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_IDAchievement", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
    ...
    partial void OnDayJointFamilyChanged();
		...
		[Association(Name="MEMBER_MEMBER_EVENT", Storage="_MEMBER_EVENTs", ThisKey="IDMember", OtherKey="IDMember")]
		public EntitySet<MEMBER_EVENT> MEMBER_EVENTs
		{
			get
			{
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_IDAchievementMember", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="MEMBER_MEMBER_EVENT", Storage="_MEMBER", ThisKey="IDMember", OtherKey="IDMember", IsForeignKey=true)]
		public MEMBER MEMBER
		{
			get
			{
    ...
    partial void OnMarriedDateChanged();
		...
		[Column(Storage="_MarriedDate", DbType="DateTime")]
