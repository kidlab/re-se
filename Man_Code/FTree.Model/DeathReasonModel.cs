...
{
    public class DeathReasonModel : BaseModel, IDeathReasonModel
    {
        #region CONSTRUCTOR

        public DeathReasonModel()
            : base()
        {

        }

        public DeathReasonModel(FTreeDataContext sharedDataContext)
        ...
        public IEnumerable<DeathReasonDTO> GetEnumerator()
        {
            ...
            {
                Tracer.Log(typeof(DeathReasonModel), exc);
