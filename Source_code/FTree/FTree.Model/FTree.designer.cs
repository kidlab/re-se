...
namespace FTree.Model
{
    ...
    partial void OnNameChanged();
		...
		[Association(Name="EVENT_MEMBER_EVENT", Storage="_MEMBER_EVENTs", ThisKey="IDEvent", OtherKey="IDEvent")]
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnIDEventMemChanging(int value);
    partial void OnIDEventMemChanged();
    partial void OnIDMemberChanging(int value);
    partial void OnIDMemberChanged();
    partial void OnIDEventChanging(int value);
    partial void OnIDEventChanged();
    ...
    partial void OnDescriptionChanged();
		...
		public int IDEventMem
		{
			get
			{
				return this._IDEventMem;
			}
			set
			{
				if ((this._IDEventMem != value))
				{
					this.OnIDEventMemChanging(value);
					this.SendPropertyChanging();
					this._IDEventMem = value;
					this.SendPropertyChanged("IDEventMem");
					this.OnIDEventMemChanged();
				}
			}
		}
		...
		[Column(Storage="_IDEvent", DbType="Int NOT NULL")]
		public int IDEvent
		{
			get
			{
		...
		[Association(Name="EVENT_MEMBER_EVENT", Storage="_EVENT", ThisKey="IDEvent", OtherKey="IDEvent", IsForeignKey=true)]
		public EVENT EVENT
		{
			get
			{
